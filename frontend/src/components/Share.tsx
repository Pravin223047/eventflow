...
import { Mail, MessageCircle, Share2Icon } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-gradient-to-r rounded-md from-rose-500 to-rose-700  text-white hover:opacity-70">
          <Share2Icon />
        </Button>
      </DialogTrigger>
